...
int main(int argc, char *argv[]) {
    ...
    mx_printstr("\n----------------MX_MEMMOVE-------------------\n");
        char src1[] = "******************************";
        char dest1[] = "abcdefghijklmnopqrstuvwxyz";
        memmove(dest1, src1, 27);
        printf("memmove    return |%s|\n",dest1);
        char src2[] = "******************************";
        char dest2[] = "abcdefghijklmnopqrstuvwxyz";
        mx_memmove(dest2, src2, 27);
    ...
    mx_printstr("\n----------------MX_REALLOC-------------------\n");
        ...
        printf("Ptr4 result before use MY mx_realloc: |%s| \t\t\t    Pointer address|%lu|\n", ptr4, (long int)ptr4);
